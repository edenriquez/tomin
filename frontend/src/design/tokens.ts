...
export const colors = {
    ...
    fog: "#f5f5f4",
    /** Hairlines and gridlines ONLY — 1.90:1. Never a data mark, never text. */
    mist: "#b9bcc2",

    /** Text — darkest to lightest */
    /** Headings, metrics, and the label on an Ember button. 19.6:1 on Paper, 6.2:1 on Ember. */
    ink: "#0a0c10",
    /** Deep surface: toasts, dark panels, the solid series in two-series charts. */
    abyss: "#15191e",
    /** Body copy. 5.94:1 — the correct default for prose. */
    graphite: "#60646c",
    /** Labels and captions down to 12px. 4.83:1 on Paper, 4.42:1 on Fog. */
    pewter: "#6e727a",
